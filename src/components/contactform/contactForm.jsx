          ...
          <div className="bg-white/5 p-8 rounded-lg shadow-lg">
            <form onSubmit={handleSubmit} className="flex flex-wrap -m-2">
              ...
              <div className="p-2 w-full">
                <button
                  type="submit"
                  className="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg transition-colors duration-300"
                >
                  Submit
                </button>
              </div>
